...
public class ModularCrmDbMigrationService : ITransientDependency
{
    ...
    private readonly ModularCrmDbSchemaMigrator _dbSchemaMigrator;
    private readonly ICurrentTenant _currentTenant;

    public ModularCrmDbMigrationService(
        IDataSeeder dataSeeder,
        ModularCrmDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "ModularCrm");
    }
