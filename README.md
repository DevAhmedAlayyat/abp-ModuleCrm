...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 713a21d7-c216-4cbc-acab-a7c521339a0d
```

> `713a21d7-c216-4cbc-acab-a7c521339a0d` is the password of the certificate, you can change it to any password you want.
